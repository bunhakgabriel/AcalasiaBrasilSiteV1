      ...
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row gap-12">
        ...
        <div className="flex-1">
          <div className="flex items-center gap-4 mb-5">
            ...
            <div className="flex-1 h-px bg-[#03ABB6] relative top-1">
              <div className="absolute -left-2 -top-1.25px w-3 h-3 border-2 border-[#03ABB6] rounded-full bg-white"></div>
            </div>
          </div>

          <p className="text-gray-600 mb-6">
            Envie uma mensagem com seus dados que em breve retornaremos o
            contato!
          </p>
        ...
        <div className="flex-1">
          ...
          <div className="flex items-center gap-4 mb-5">
            ...
            <div className="flex-1 h-px bg-[#03ABB6] relative top-1">
              <div className="absolute -left-2 -top-1.25 w-3 h-3 border-2 border-[#03ABB6] rounded-full bg-white"></div>
            </div>
          </div>
